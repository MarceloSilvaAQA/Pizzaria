...
public class DlgAdicionarBebida extends JDialog {
	...
	private class ActionOk implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (!testaNumeroPositivo(textQuantidade, "quantidade")) {
				return;
			}
	...
	public boolean testaNumeroPositivo(JTextField field, String label) {

		if(Integer.valueOf(field.getText()) > 0) {
			return true;
		}
		JOptionPane.showMessageDialog(botaoOk, label + " precisa ser um numero positivo");
		return false;
	}
